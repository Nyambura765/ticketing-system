...
SECRET_KEY = 'django-insecure-x5h6ga2n$ep%mbr2iwv+4=!y=t^k%!zh_k1p*kqe*pfs*1!65m'
...
MPESA_TOKEN_URL = f'{MPESA_API_URL}/access_token'
MPESA_STK_PUSH_URL = f'{MPESA_API_URL}/stkpush/v1/processrequest'
